...
ATP1TNFCharacter::ATP1TNFCharacter()
{
...
void ATP1TNFCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATP1TNFCharacter::Move);
...
void ATP1TNFCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATP1TNFCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
